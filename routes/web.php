...
// Admin Routes (Barangay Office Staff & Councilors)
Route::middleware('auth.admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    // Documents (Admin, Captain, Secretary)
    ...
    Route::post('/service-logs/{serviceLog}/assign', [ServiceLogController::class, 'assign'])->middleware('role:captain,administrator,secretary')->name('service-logs.assign');
    ...
    Route::middleware('role:captain,administrator')->group(function () {
    ...
    // Users (Captain & System Administrator only)
    Route::middleware('role:captain,administrator')->group(function () {
        Route::resource('users', UserController::class);
        Route::post('/users/{user}/deactivate', [UserController::class, 'deactivate'])->name('users.deactivate');
    });

    // Settings (Captain & System Administrator only)
    Route::middleware('role:captain,administrator')->group(function () {
